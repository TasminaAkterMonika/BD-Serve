...
class OrderrequestController extends Controller {
	...
	public static function display(  )
	{
		...
		$info = $model::makeInfo('orderrequest');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('orderrequest.public.view',$data);			
			}			
		} 
		else {
			...
			return view('orderrequest.public.index',$data);	
		}

...
class FaqdescriptionController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'faqdescription';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Faqdescription();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'faqdescription',
	...
	public static function display(  )
	{
		...
		$model  = new Faqdescription();
		$info = $model::makeInfo('faqdescription');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('faqdescription.public.view',$data);			
			}			
		} 
		else {
			...
			return view('faqdescription.public.index',$data);	
		}

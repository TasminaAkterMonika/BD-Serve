...
class AllbannerController extends Controller {
	...
	public $module = 'allbanner';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Allbanner();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'allbanner',
	...
	public static function display(  )
	{
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('allbanner.public.view',$data);			
			}			
		} 
		else {
			...
			return view('allbanner.public.index',$data);	
		}

...
class HomebannerController extends Controller {
	...
	public $module = 'homebanner';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Homebanner();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'homebanner',
	...
	public static function display(  )
	{
		...
		$info = $model::makeInfo('homebanner');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('homebanner.public.view',$data);			
			}			
		} 
		else {
			...
			return view('homebanner.public.index',$data);	
		}

...
class DonerlistController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'donerlist';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Donerlist();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'donerlist',
	...
	public static function display(  )
	{
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('donerlist.public.view',$data);			
			}			
		} 
		else {
			...
			return view('donerlist.public.index',$data);	
		}

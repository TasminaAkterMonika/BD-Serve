...
class UpcommingeventController extends Controller {
	...
	public $module = 'upcommingevent';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Upcommingevent();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'upcommingevent',
	...
	public static function display(  )
	{
		...
		$model  = new Upcommingevent();
		$info = $model::makeInfo('upcommingevent');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('upcommingevent.public.view',$data);			
			}			
		} 
		else {
			...
			return view('upcommingevent.public.index',$data);	
		}

				...
				{!! Form::hidden('id', $row['id']) !!}					
						...
						<div class="image-preview preview-upload">
						 ...
						 >{{ $row['about_us'] }}</textarea> 
									  ...
									  <div class="form-group row  " >
										<label for="Certified" class=" control-label col-md-4 text-left"> Certified </label>
										<div class="col-md-6">
										  <input  type='text' name='certified' id='certified' value='{{ $row['certified'] }}' 
						     class='form-control form-control-sm ' /> 
									  ...
									  <div class="form-group row  " >
										<label for="Certified Icon" class=" control-label col-md-4 text-left"> Certified Icon </label>
										<div class="col-md-6">
										  <input  type='text' name='certified_icon' id='certified_icon' value='{{ $row['certified_icon'] }}' 
						     class='form-control form-control-sm ' /> 
										 </div> 
										 <div class="col-md-2">
									  ...
									  <div class="form-group row  " >
										<label for="M Icon" class=" control-label col-md-4 text-left"> M Icon </label>
										<div class="col-md-6">
										  <input  type='text' name='m_icon' id='m_icon' value='{{ $row['m_icon'] }}' 
						     class='form-control form-control-sm ' /> 
										 </div> 
										 <div class="col-md-2">
									  ...
									  <div class="form-group row  " >
										...
										<div class="col-md-6">
										  <input  type='text' name='mission' id='mission' value='{{ $row['mission'] }}' 
						     class='form-control form-control-sm ' /> 
										 </div> 
										 <div class="col-md-2">
									  ...
									  <div class="form-group row  " >
										<label for="V Icon" class=" control-label col-md-4 text-left"> V Icon </label>
										<div class="col-md-6">
										  <input  type='text' name='v_icon' id='v_icon' value='{{ $row['v_icon'] }}' 
						     class='form-control form-control-sm ' /> 
										 </div> 
										 <div class="col-md-2">
									  ...
									  <div class="form-group row  " >
										...
										<div class="col-md-6">
										  <input  type='text' name='vision' id='vision' value='{{ $row['vision'] }}' 
						     class='form-control form-control-sm ' /> 
										 </div> 
										 <div class="col-md-2">
									  ...
									  <div class="form-group row  " >
										<label for="E Icon" class=" control-label col-md-4 text-left"> E Icon </label>
										<div class="col-md-6">
										  <input  type='text' name='e_icon' id='e_icon' value='{{ $row['e_icon'] }}' 
						     class='form-control form-control-sm ' /> 
										 </div> 
										 <div class="col-md-2">

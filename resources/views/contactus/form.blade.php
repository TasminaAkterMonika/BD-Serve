				...
				{!! Form::hidden('id', $row['id']) !!}					
						 ...
						 >{{ $row['description'] }}</textarea> 
									  ...
									  <div class="form-group row  " >
										...
										<div class="col-md-6">
										  <input  type='text' name='fb' id='fb' value='{{ $row['fb'] }}' 
						     ...
						     class='form-control form-control-sm ' /> 
									  ...
									  <div class="form-group row  " >
										<label for="Linkdin" class=" control-label col-md-4 text-left"> Linkdin </label>
										<div class="col-md-6">
										  <input  type='text' name='linkdin' id='linkdin' value='{{ $row['linkdin'] }}' 
						     class='form-control form-control-sm ' /> 
										 </div> 
										 <div class="col-md-2">
									  ...
									  <div class="form-group row  " >
										<label for="Insta" class=" control-label col-md-4 text-left"> Insta </label>
										<div class="col-md-6">
										  <input  type='text' name='insta' id='insta' value='{{ $row['insta'] }}' 
						     class='form-control form-control-sm ' /> 
										 </div> 
										 <div class="col-md-2">

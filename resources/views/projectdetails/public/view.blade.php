	...
	<div class="table-container" > 	
		...
		<table class="table table-striped table-bordered" >
			<tbody>	
					...
					<tr>
						<td width='30%' class='label-view text-right'>{{ SiteHelpers::activeLang('Status1', (isset($fields['status1']['language'])? $fields['status1']['language'] : array())) }}</td>
						<td>{{ $row->status1}} </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'>{{ SiteHelpers::activeLang('Result', (isset($fields['result']['language'])? $fields['result']['language'] : array())) }}</td>
						<td>{{ $row->result}} </td>

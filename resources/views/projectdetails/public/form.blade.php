		 ...
		 {!! Form::open(array('url'=>'projectdetails', 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ')) !!}
...
<div class="col-md-12">
					...
					@foreach($row['image'] as $files)
						@if(file_exists('./uploads/images/project'.$files) && $files !='')
						<li id="cr-<?php echo $cr;?>" class="">							
							<a href="{{ url('/uploads/images/project/'.$files) }}" target="_blank" >
							{!! SiteHelpers::showUploadedFile( $files ,"/uploads/images/",100) !!}
							</a> 
							<span class="pull-right removeMultiFiles" rel="cr-<?php echo $cr;?>" url="/uploads/images/project{{$files}}">
					...
					@endforeach
						     ...
						     class='form-control form-control-sm ' /> 
									  ...
									  <div class="form-group row  " >
										<label for="Status1" class=" control-label col-md-4 text-left"> Status1 </label>
										<div class="col-md-6">
										  <input  type='text' name='status1' id='status1' value='{{ $row['status1'] }}' 
						     class='form-control form-control-sm ' /> 
										 </div> 
										 <div class="col-md-2">
									  ...
									  <div class="form-group row  " >
										<label for="Result" class=" control-label col-md-4 text-left"> Result </label>
										<div class="col-md-6">
										  <input  type='text' name='result' id='result' value='{{ $row['result'] }}' 
						     class='form-control form-control-sm ' /> 
										 </div> 
										 <div class="col-md-2">
   ...
   <script type="text/javascript">
	$(document).ready(function() { 
		...
		$("#status").jCombo("{!! url('projectdetails/comboselect?filter=status:id:title') !!}",
